...
2.Stability/quality of little-used packages is often not as high as the core distribution.<br>  

3.Powerful hardware is required when working with very large data sets.<br>  
